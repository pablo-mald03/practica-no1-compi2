...
public class TokenStyleResolver implements TokenStyleProvider {
    ...
    public TokenStyle style(Token token) {
        ...
        return switch (token.getType()) {
            case CodexLatinusLexer.BLOCK_COMMENT, CodexLatinusLexer.COMMENT ->
                TokenStyle.COMMENT;
            case CodexLatinusLexer.INT, CodexLatinusLexer.DECIMAL ->
                TokenStyle.NUMBER;
            ...
            case CodexLatinusLexer.ABREV_MINUS, CodexLatinusLexer.ABREV_PLUS, CodexLatinusLexer.PLUS, 
                ...
                CodexLatinusLexer.EQUALS,CodexLatinusLexer.GREATER_EQUALS, CodexLatinusLexer.LESS_EQUALS, CodexLatinusLexer.DIFERENCE,
                CodexLatinusLexer.LESS, CodexLatinusLexer.GREATER, CodexLatinusLexer.AND, CodexLatinusLexer.OR, CodexLatinusLexer.NOT, CodexLatinusLexer.EQUAL, 
                CodexLatinusLexer.MUNERA, CodexLatinusLexer.MAIOR, CodexLatinusLexer.VARIABILES, CodexLatinusLexer.FINIS_SEPARATOR->
                TokenStyle.OPERATOR;
            case CodexLatinusLexer.NUMERUS, CodexLatinusLexer.LITTERA, 
                ...
                CodexLatinusLexer.SERIES, CodexLatinusLexer.STRUCTURE, CodexLatinusLexer.FINIS, CodexLatinusLexer.VERUM, CodexLatinusLexer.FALSUS,
                CodexLatinusLexer.DUM, CodexLatinusLexer.PER, CodexLatinusLexer.FACERE, CodexLatinusLexer.SI, CodexLatinusLexer.ALITER, CodexLatinusLexer.ACTIO,
            ...
            case CodexLatinusLexer.INIT_BRACE, CodexLatinusLexer.FINAL_BRACE, CodexLatinusLexer.INIT_PARENT, CodexLatinusLexer.FINAL_PARENT,
                CodexLatinusLexer.INIT_BRACKET, CodexLatinusLexer.FINAL_BRACKET
                    -> TokenStyle.PUNCTUATION;  
                
            case CodexLatinusLexer.COMMA, CodexLatinusLexer.DOT_COMMA, CodexLatinusLexer.TWO_POINTS,
                CodexLatinusLexer.DOT
                    -> TokenStyle.SEPARATOR;
            case CodexLatinusLexer.ERROR_TOKEN
                    -> TokenStyle.ERROR;
